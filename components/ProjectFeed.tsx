...
export default function ProjectFeed() {
  ...
  return (
    <div className="relative w-full max-w-xs h-full px-2">
      {/* Add padding around the scroll container so scaled cards don’t clip */}
      <div className="relative w-full h-full pt-8 pb-8 overflow-hidden">
          ...
          <div className="flex flex-col items-center space-y-6 px-2">
            {[...projects, ...projects].map((project, index) => (
              <div
                ...
                className="p-4 rounded-lg border border-gray-300 bg-[#1a1a2e] text-white shadow-md text-sm transform-gpu transition-transform w-[280px] hover:scale-[1.05]"
              >
